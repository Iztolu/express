...
<div class="view" style="background-image: url('images/bus.jpg'); background-repeat: no-repeat; background-size: cover;">
    ...
    <audio src="videos/1.mp3" autoplay loop></audio> -->
    ...
    <!-- Content -->
      <!-- <div class="text-center white-text mx-5 wow fadeIn">
        ...
        <h4 class="mb-4 d-none d-md-block">
          <strong><h1><?= date('d-m-Y'); ?></h1></strong>
          <strong><h1><?= date('h:m A'); ?></h1></strong>
